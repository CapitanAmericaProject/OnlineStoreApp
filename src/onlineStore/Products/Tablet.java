...
public class Tablet extends Electronic implements Commentable, ColorChangeable {
    private int displaySize;
    private OperationSystemType operationSystem;
    private WirelessTechnologyType wirelessTech;
    ArrayList<String> comments;

    public Tablet(String description, double price, String image, String brand, String model, String color, int displaySize, OperationSystemType operationSystem, WirelessTechnologyType wirelessTech) {
